...
const aboutSection = () => {
    return (
        <div>
            <div className="flex flex-col md:flex-row md:h-150 items-center">
                <Image className="m-4 md:m-10 shadow-[0_4px_8px_rgba(0,0,0,0.3)] rounded-lg md:my-10" src={pic1} alt="" width={320} height={220} />
                <div className="p-4 md:p-10 my-4 font-light tracking-wider text-lg md:text-2xl">
                    Welcome to IIT Goa canteen! <br />
            ...
            <div className="flex flex-col md:flex-row items-center">
                <div className="p-4 md:p-10">
                    <b className="text-2xl md:text-3xl tracking-wider">Our Mission </b><br />
                    ...
                    <br />
                    <div>
                        <b className="tracking-wider text-2xl md:text-3xl">What we offer</b><br />
                        <span className="text-lg md:text-2xl font-light tracking-wider">We understand that everyone's tastes and needs are different. That's why we offer:</span>
                        <ul className="text-base md:text-xl font-light tracking-wider list-disc ml-5">
                ...
                <Image className="m-4 md:m-10 shadow-[0_4px_8px_rgba(0,0,0,0.3)] rounded-lg" src={pic2} alt="" width={280} height={210} />
            </div>
            <br /><br /><hr />
            <div className="flex flex-col md:flex-row items-center">
                <Image className="m-4 md:m-10 shadow-[0_4px_8px_rgba(0,0,0,0.3)] rounded-lg" src={pic3} alt="" width={340} height={220} />
                <div className="m-4 md:m-10">
                    <b className="text-2xl md:text-3xl">Our Values</b>
                    <br />
                    <ol type="1" className="text-base md:text-xl font-light list-decimal ml-5">
                    ...
                    <br />
                    <b className="text-2xl md:text-3xl">Our Story</b>
